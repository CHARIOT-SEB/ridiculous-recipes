		...
		<div>
			...
			<div className='results'>
				...
				<div className='steps'>
					...
					<ol>
						<li>
							{rn(verbs)} your {rn(ingredients)} for {rnNo(40)} minutes until {rn(adjectives)}
						</li>
						<li>
							{rn(adverbs)} {rn(verbs)} the {rn(ingredients)} using your {rn(equipment)}
						</li>
						<li>{rn(sentences)}</li>
						<li>
							take a {rn(equipment)} and {rn(verbs)} it {rn(adverbs)} into the {rn(ingredients)}
						</li>
